...
IF YOU WOULD LIKE TO practice working with JSON data, a local `data.json` file is provided for the activities. This means you'll be able to pull the data from there instead of using the content in the `.html` file.
